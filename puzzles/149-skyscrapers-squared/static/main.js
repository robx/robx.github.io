...
var _ktonon$elm_word$Word_Helpers$safeXor = F2(
	function (x, y) {
		return A2(_elm_lang$core$Basics_ops['%'], x ^ y, 4294967296);
	});
var _ktonon$elm_word$Word_Helpers$safeAnd = F2(
	function (x, y) {
		return A2(_elm_lang$core$Basics_ops['%'], x & y, 4294967296);
	});
var _ktonon$elm_word$Word_Helpers$safeShiftLeftBy = F2(
	function (n, val) {
		return A2(_elm_lang$core$Basics_ops['%'], val << n, 4294967296);
	});
...
var _ktonon$elm_word$Word_Helpers$rotatedLowBits = F2(
	function (n, val) {
		return F2(
			...
			A2(
				_ktonon$elm_word$Word_Helpers$safeShiftLeftBy,
				32 - n,
				_ktonon$elm_word$Word_Helpers$lowMask(n) & val));
	});
		...
		return (_elm_lang$core$Native_Utils.cmp(n, 32) > 0) ? {
			...
			_1: A2(
				...
				A2(
					_ktonon$elm_word$Word_Helpers$safeShiftLeftBy,
					32 - n,
					_ktonon$elm_word$Word_Helpers$lowMask(n) & _p2))
		};
	});
...
var _ktonon$elm_word$Word$accWords = F3(
	function (wordSize, bytes, acc) {
		accWords:
		while (true) {
			var _p10 = {ctor: '_Tuple2', _0: wordSize, _1: bytes};
			_v6_2:
			do {
				if (_p10._0.ctor === 'Bit32') {
					if (_p10._1.ctor === '::') {
						if (((_p10._1._1.ctor === '::') && (_p10._1._1._1.ctor === '::')) && (_p10._1._1._1._1.ctor === '::')) {
							var _v7 = wordSize,
								_v8 = _p10._1._1._1._1._1,
								_v9 = A2(
								_elm_lang$core$Array$push,
								_ktonon$elm_word$Word$W(
									_ktonon$elm_word$Word$int32FromBytes(
										{ctor: '_Tuple4', _0: _p10._1._0, _1: _p10._1._1._0, _2: _p10._1._1._1._0, _3: _p10._1._1._1._1._0})),
								acc);
							wordSize = _v7;
							bytes = _v8;
							acc = _v9;
							...
							return A2(
								...
								_ktonon$elm_word$Word$W(
									_ktonon$elm_word$Word$int32FromBytes(
										_ktonon$elm_word$Word$pad4(_p10._1))),
								acc);
						}
					} else {
						break _v6_2;
					...
					if (_p10._1.ctor === '::') {
						if (((((((_p10._1._1.ctor === '::') && (_p10._1._1._1.ctor === '::')) && (_p10._1._1._1._1.ctor === '::')) && (_p10._1._1._1._1._1.ctor === '::')) && (_p10._1._1._1._1._1._1.ctor === '::')) && (_p10._1._1._1._1._1._1._1.ctor === '::')) && (_p10._1._1._1._1._1._1._1._1.ctor === '::')) {
							var _v10 = wordSize,
								_v11 = _p10._1._1._1._1._1._1._1._1._1,
								_v12 = A2(
								_elm_lang$core$Array$push,
								A2(
									...
									_ktonon$elm_word$Word$int32FromBytes(
										{ctor: '_Tuple4', _0: _p10._1._0, _1: _p10._1._1._0, _2: _p10._1._1._1._0, _3: _p10._1._1._1._1._0}),
									_ktonon$elm_word$Word$int32FromBytes(
										{ctor: '_Tuple4', _0: _p10._1._1._1._1._1._0, _1: _p10._1._1._1._1._1._1._0, _2: _p10._1._1._1._1._1._1._1._0, _3: _p10._1._1._1._1._1._1._1._1._0})),
								acc);
							wordSize = _v10;
							bytes = _v11;
							acc = _v12;
								...
								A2(
									...
									_ktonon$elm_word$Word$int32FromBytes(
										_ktonon$elm_word$Word$pad4(
											A2(_elm_lang$core$List$take, 4, _p11))),
									_ktonon$elm_word$Word$int32FromBytes(
										_ktonon$elm_word$Word$pad4(
											A2(_elm_lang$core$List$drop, 4, _p11)))),
								acc);
						}
					} else {
						break _v6_2;
...
var _ktonon$elm_word$Word$fromUTF8 = function (wordSize) {
	return function (_p12) {
		return A2(
			...
			wordSize,
			_ktonon$elm_word$Word_Bytes$fromUTF8(_p12));
	};
};
var _ktonon$elm_word$Word$add = F2(
	function (x, y) {
		var _p13 = {ctor: '_Tuple2', _0: x, _1: y};
		_v13_2:
		do {
					...
					case 'W':
						if (_p13._1.ctor === 'W') {
							return _ktonon$elm_word$Word$W(
								_ktonon$elm_word$Word$mod32(_p13._0._0 + _p13._1._0));
						} else {
							break _v13_2;
						}
					case 'D':
						if (_p13._1.ctor === 'D') {
							var zl = _p13._0._1 + _p13._1._1;
							var zh = (_p13._0._0 + _p13._1._0) + _ktonon$elm_word$Word$rem32(zl);
							return A2(
								_ktonon$elm_word$Word$D,
			...
			case 'W':
				...
				return _ktonon$elm_word$Word$W(
					A3(
						...
						n,
						_p15,
						A2(_ktonon$elm_word$Word_Helpers$safeShiftRightZfBy, n, _p15)));
			case 'D':
				var _p19 = _p14._1;
				var _p18 = _p14._0;
				...
				if (_elm_lang$core$Native_Utils.cmp(n, 32) > 0) {
					...
					return A2(
						_ktonon$elm_word$Word$D,
						A3(_ktonon$elm_word$Word_Helpers$rotatedLowBits, n_, _p18, zh),
						zl);
				} else {
					var _p17 = A2(
						_ktonon$elm_word$Word$dShiftRightZfBy,
					...
					return A2(
						_ktonon$elm_word$Word$D,
						A3(_ktonon$elm_word$Word_Helpers$rotatedLowBits, n, _p19, zh),
						zl);
				}
			default:
				return _ktonon$elm_word$Word$Mismatch;
...
var _ktonon$elm_word$Word$shiftRightZfBy = F2(
	function (n, word) {
		...
		switch (_p20.ctor) {
			case 'W':
				return _ktonon$elm_word$Word$W(
					A2(_ktonon$elm_word$Word_Helpers$safeShiftRightZfBy, n, _p20._0));
			case 'D':
				var _p21 = A2(
					_ktonon$elm_word$Word$dShiftRightZfBy,
					n,
...
var _ktonon$elm_word$Word$and = F2(
	function (x, y) {
		var _p22 = {ctor: '_Tuple2', _0: x, _1: y};
		_v16_2:
		do {
			if (_p22.ctor === '_Tuple2') {
				switch (_p22._0.ctor) {
					case 'W':
						if (_p22._1.ctor === 'W') {
							return _ktonon$elm_word$Word$W(
								A2(_ktonon$elm_word$Word_Helpers$safeAnd, _p22._0._0, _p22._1._0));
						} else {
							break _v16_2;
						}
					case 'D':
						if (_p22._1.ctor === 'D') {
							return A2(
								_ktonon$elm_word$Word$D,
								A2(_ktonon$elm_word$Word_Helpers$safeAnd, _p22._0._0, _p22._1._0),
								A2(_ktonon$elm_word$Word_Helpers$safeAnd, _p22._0._1, _p22._1._1));
						} else {
							break _v16_2;
						}
					default:
...
var _ktonon$elm_word$Word$xor = F2(
	function (x, y) {
		var _p23 = {ctor: '_Tuple2', _0: x, _1: y};
		_v17_2:
		do {
			if (_p23.ctor === '_Tuple2') {
				switch (_p23._0.ctor) {
					case 'W':
						if (_p23._1.ctor === 'W') {
							return _ktonon$elm_word$Word$W(
								A2(_ktonon$elm_word$Word_Helpers$safeXor, _p23._0._0, _p23._1._0));
						} else {
							break _v17_2;
						}
					case 'D':
						if (_p23._1.ctor === 'D') {
							return A2(
								_ktonon$elm_word$Word$D,
								A2(_ktonon$elm_word$Word_Helpers$safeXor, _p23._0._0, _p23._1._0),
								A2(_ktonon$elm_word$Word_Helpers$safeXor, _p23._0._1, _p23._1._1));
						} else {
							break _v17_2;
						}
					default:
...
var _ktonon$elm_word$Word$complement = function (x) {
	...
	switch (_p24.ctor) {
		case 'W':
			return _ktonon$elm_word$Word$W(~_p24._0);
		case 'D':
			return A2(_ktonon$elm_word$Word$D, ~_p24._0, ~_p24._1);
		default:
			return _ktonon$elm_word$Word$Mismatch;
	}
};
...
var _user$project$Main$normalize = function () {
...
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {puzzle: a, code: b, result: c, mdl: d};
	});
var _user$project$Main$Puzzle = F5(
	function (a, b, c, d, e) {
		return {name: a, codeDescription: b, code: c, codeLabel: d, valid: e};
	});
...
var _user$project$Main$CodeChange = function (a) {
	return {ctor: 'CodeChange', _0: a};
};
var _user$project$Main$Wrong = {ctor: 'Wrong'};
var _user$project$Main$Correct = {ctor: 'Correct'};
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'Check':
				var _p3 = model.puzzle.valid(model.code);
				var norm = _p3._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							result: _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.eq(
									model.puzzle.code,
									_ktonon$elm_crypto$Crypto_Hash$sha256(norm)) ? _user$project$Main$Correct : _user$project$Main$Wrong)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NoOp':
...
var _user$project$Main$viewPuzzle = function (model) {
	var result = function () {
		var _p4 = model.result;
		if (_p4.ctor === 'Nothing') {
			return A2(
				_elm_lang$html$Html$span,
				{ctor: '[]'},
	...
	var _p5 = puzzle.valid(model.code);
	var norm = _p5._0;
	var valid = _p5._1;
	var err = function () {
		var _p6 = valid;
	...
	var cls = function () {
		if (_elm_lang$core$Native_Utils.eq(model.code, '')) {
			return 'empty';
		} else {
			var _p7 = valid;
			switch (_p7.ctor) {
	...
	var submit = _elm_lang$core$Native_Utils.eq(valid, _user$project$Main$Valid) ? {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$Check),
		_1: {ctor: '[]'}
	} : {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_user$project$Main$NoOp),
		_1: {ctor: '[]'}
	};
	return A2(
		_debois$elm_mdl$Material_Options$div,
			...
			_0: A2(
					...
					submit),
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(puzzle.name),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(puzzle.codeDescription),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A5(
								...
								{
									ctor: '::',
									_0: _debois$elm_mdl$Material_Textfield$label(puzzle.codeLabel),
									_1: {
										ctor: '::',
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Textfield$value(model.code),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onInput(_user$project$Main$CodeChange),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$maybe(
															A2(_elm_lang$core$Maybe$map, _debois$elm_mdl$Material_Textfield$error, err)),
														_1: {ctor: '[]'}
													}
												}
											}
							...
							_1: {
								...
								_0: A5(
									...
									{
										ctor: '::',
										_0: _debois$elm_mdl$Material_Options$disabled(
											!_elm_lang$core$Native_Utils.eq(valid, _user$project$Main$Valid)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _user$project$Main$view = function (model) {
	return _user$project$Main$viewPuzzle(model);
};
var _user$project$Main$Incomplete = {ctor: 'Incomplete'};
var _user$project$Main$Invalid = function (a) {
	return {ctor: 'Invalid', _0: a};
};
var _user$project$Main$fillomino = F2(
	function (n, s) {
		var norm = _user$project$Main$normalize(s);
		var v = (!A2(_elm_lang$core$String$all, _elm_lang$core$Char$isDigit, norm)) ? _user$project$Main$Invalid('Invalid characters, digits only.') : ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(norm),
			n) > 0) ? _user$project$Main$Invalid(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Too long, want ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(n),
					' digits'))) : ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(norm),
			n) < 0) ? _user$project$Main$Incomplete : _user$project$Main$Valid));
		return {ctor: '_Tuple2', _0: norm, _1: v};
	});
var _user$project$Main$fillo = {
	name: 'Puzzle 148: Fillomino',
	codeDescription: '\n        Enter the size of the polyomino for each cell in the row or column.\n        For polyominoes of size 10 or greater, enter the last digit only.\n        ',
	codeLabel: 'Rows 3 and 10',
	code: '5b718bfd9f1e15fe54236fd614823c1a69fe1df82d4ba8b7e3c1b8f9edac5f57',
	valid: _user$project$Main$fillomino(20)
};
var _user$project$Main$sky = {
	name: 'Puzzle 149: Skyscrapers Squared',
	codeDescription: '\n        Enter the regular skyscraper clues in clockwise order, starting\n        in the top left corner.\n        ',
	codeLabel: 'Regular skyscraper clues, clockwise',
	code: 'a28c1146497ef4ea402e43bb200aa08791c5cdddcfb95b508fc2d77913c8988e',
	valid: _user$project$Main$fillomino(20)
};
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {puzzle: _user$project$Main$sky, code: '', result: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model},
	_1: _elm_lang$core$Platform_Cmd$none
};
