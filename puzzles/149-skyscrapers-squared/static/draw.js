...
var _user$project$Mouse_ops = _user$project$Mouse_ops || {};
_user$project$Mouse_ops['&>'] = F2(
	function (t1, t2) {
		return A2(
			_elm_lang$core$Task$andThen,
			function (_p0) {
...
var _user$project$Mouse$onSelfMsg = F3(
	function (router, _p1, state) {
		...
		if (_p3.ctor === 'Nothing') {
			...
			return A2(
				_user$project$Mouse_ops['&>'],
				_elm_lang$core$Task$sequence(
					A2(_elm_lang$core$List$map, send, _p3._0.taggers)),
				_elm_lang$core$Task$succeed(state));
		}
	});
var _user$project$Mouse$init = _elm_lang$core$Task$succeed(_elm_lang$core$Dict$empty);
var _user$project$Mouse$categorizeHelpHelp = F2(
	function (value, maybeValues) {
		var _p4 = maybeValues;
		if (_p4.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Just(
...
var _user$project$Mouse$categorizeHelp = F2(
	function (subs, subDict) {
		categorizeHelp:
		while (true) {
			var _p5 = subs;
			if (_p5.ctor === '[]') {
				...
				var _v4 = _p5._1,
					...
					_elm_lang$core$Dict$update,
					_p5._0._0,
					_user$project$Mouse$categorizeHelpHelp(_p5._0._1),
					subDict);
				subs = _v4;
				subDict = _v5;
				continue categorizeHelp;
...
var _user$project$Mouse$categorize = function (subs) {
	return A2(_user$project$Mouse$categorizeHelp, subs, _elm_lang$core$Dict$empty);
};
var _user$project$Mouse$subscription = _elm_lang$core$Native_Platform.leaf('Mouse');
var _user$project$Mouse$Position = F8(
	function (a, b, c, d, e, f, g, h) {
		return {pageX: a, pageY: b, clientX: c, clientY: d, ctrlKey: e, altKey: f, metaKey: g, button: h};
	});
var _user$project$Mouse$position = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$Mouse$Position,
...
var _user$project$Mouse$Watcher = F2(
	function (a, b) {
		return {taggers: a, pid: b};
	});
var _user$project$Mouse$Msg = F2(
	function (a, b) {
		return {category: a, position: b};
	});
var _user$project$Mouse$onEffects = F3(
	function (router, newSubs, oldState) {
		var rightStep = F3(
			function (category, taggers, task) {
				var tracker = A3(
					...
					function (_p6) {
						return A2(
							_elm_lang$core$Platform$sendToSelf,
							router,
							A2(_user$project$Mouse$Msg, category, _p6));
					});
				return A2(
					_elm_lang$core$Task$andThen,
					function (state) {
							...
							function (pid) {
								return _elm_lang$core$Task$succeed(
									A3(
										_elm_lang$core$Dict$insert,
										category,
										A2(_user$project$Mouse$Watcher, taggers, pid),
										state));
							},
					...
					function (state) {
						return _elm_lang$core$Task$succeed(
							A3(
								_elm_lang$core$Dict$insert,
								category,
								A2(_user$project$Mouse$Watcher, taggers, _p8.pid),
								state));
					},
					task);
			});
		...
		return A6(
			...
			rightStep,
			oldState,
			_user$project$Mouse$categorize(newSubs),
			_elm_lang$core$Task$succeed(_elm_lang$core$Dict$empty));
	});
var _user$project$Mouse$MyMouseSub = F2(
	function (a, b) {
		return {ctor: 'MyMouseSub', _0: a, _1: b};
	});
var _user$project$Mouse$clicks = function (tagger) {
	return _user$project$Mouse$subscription(
		A2(_user$project$Mouse$MyMouseSub, 'click', tagger));
};
var _user$project$Mouse$moves = function (tagger) {
	return _user$project$Mouse$subscription(
		A2(_user$project$Mouse$MyMouseSub, 'mousemove', tagger));
};
var _user$project$Mouse$downs = function (tagger) {
	return _user$project$Mouse$subscription(
		A2(_user$project$Mouse$MyMouseSub, 'mousedown', tagger));
};
var _user$project$Mouse$ups = function (tagger) {
	return _user$project$Mouse$subscription(
		A2(_user$project$Mouse$MyMouseSub, 'mouseup', tagger));
};
var _user$project$Mouse$subMap = F2(
	function (func, _p11) {
		var _p12 = _p11;
		return A2(
			_user$project$Mouse$MyMouseSub,
			_p12._0,
			function (_p13) {
				return func(
					_p12._1(_p13));
...
_elm_lang$core$Native_Platform.effectManagers['Mouse'] = {pkg: 'user/project', init: _user$project$Mouse$init, onEffects: _user$project$Mouse$onEffects, onSelfMsg: _user$project$Mouse$onSelfMsg, tag: 'sub', subMap: _user$project$Mouse$subMap};

var _user$project$Draw$lineStyle = function () {
	var style = _evancz$elm_graphics$Collage$defaultLine;
	return _elm_lang$core$Native_Utils.update(
		style,
		{color: _elm_lang$core$Color$red, width: 5, cap: _evancz$elm_graphics$Collage$Round});
}();
var _user$project$Draw$drawKey = F2(
	function (p, k) {
		return A2(
...
var _user$project$Draw$inBounds = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1._1;
	var _p2 = _p1._0;
	return (_elm_lang$core$Native_Utils.cmp(_p2, -200) > -1) && ((_elm_lang$core$Native_Utils.cmp(_p2, 200) < 1) && ((_elm_lang$core$Native_Utils.cmp(_p3, -200) > -1) && (_elm_lang$core$Native_Utils.cmp(_p3, 200) < 1)));
};
var _user$project$Draw$toForm = function (ps) {
	var _p4 = ps;
	if ((_p4.ctor === '::') && (_p4._1.ctor === '[]')) {
		return A2(
			...
			A2(
				...
				_elm_lang$core$Color$red,
				_evancz$elm_graphics$Collage$circle(2.5)));
	} else {
		return A2(
			_evancz$elm_graphics$Collage$traced,
			_user$project$Draw$lineStyle,
			_evancz$elm_graphics$Collage$path(ps));
	}
};
var _user$project$Draw$clamp = function (_p5) {
	var _p6 = _p5;
	var _p8 = _p6._1;
	var _p7 = _p6._0;
	var m = A2(
	...
	var f = (_elm_lang$core$Native_Utils.cmp(m, 200) > 0) ? (200 / m) : 1;
	return {ctor: '_Tuple2', _0: f * _p7, _1: f * _p8};
};
var _user$project$Draw$toCoord = F2(
	function (pos, _p9) {
		var _p10 = _p9;
		return {
			ctor: '_Tuple2',
			_0: (_p10._0 - _elm_lang$core$Basics$toFloat(pos.left)) - 200,
			_1: 200 - (_p10._1 - _elm_lang$core$Basics$toFloat(pos.top))
		};
	});
var _user$project$Draw$getPos = _elm_lang$core$Native_Platform.outgoingPort(
	'getPos',
	function (v) {
		return null;
	});
var _user$project$Draw$init = {
	ctor: '_Tuple2',
	_0: {
		draw: _elm_lang$core$Maybe$Nothing,
		drawing: {ctor: '[]'},
		background: A3(_evancz$elm_graphics$Element$image, 400, 400, 'skyscrapers-square.png'),
		mousePos: {ctor: '_Tuple2', _0: 0, _1: 0},
		pos: {top: 0, left: 0},
		redo: {ctor: '[]'}
	},
	_1: _user$project$Draw$getPos(
		{ctor: '_Tuple0'})
};
var _user$project$Draw$update = F2(
	function (msg, model) {
		var addPos = F2(
			function (pos, ps) {
				var p = _user$project$Draw$clamp(
					A2(
						_user$project$Draw$toCoord,
						model.pos,
						{ctor: '_Tuple2', _0: pos.pageX, _1: pos.pageY}));
				var _p11 = ps;
				if (_p11.ctor === '::') {
					return _elm_lang$core$Native_Utils.eq(_p11._0, p) ? ps : {ctor: '::', _0: p, _1: ps};
				} else {
					return {
						ctor: '::',
						_0: p,
		...
		switch (_p12.ctor) {
			case 'DrawStart':
				var _p13 = _p12._0;
				return ((!_elm_lang$core$Native_Utils.eq(_p13.button, 0)) || _p13.ctrlKey) ? {
					ctor: '_Tuple2',
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							draw: _elm_lang$core$Maybe$Just(
								{
									ctor: '::',
									_0: _user$project$Draw$clamp(
										A2(
											_user$project$Draw$toCoord,
											model.pos,
											{ctor: '_Tuple2', _0: _p13.pageX, _1: _p13.pageY})),
									_1: {ctor: '[]'}
								}),
							redo: {ctor: '[]'}
						}),
				...
				var model2 = _elm_lang$core$Native_Utils.update(
					model,
					{
						mousePos: A2(
							_user$project$Draw$toCoord,
							model.pos,
							{ctor: '_Tuple2', _0: _p15.pageX, _1: _p15.pageY})
					});
				var _p14 = model2.draw;
				if (_p14.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								drawing: {
									ctor: '::',
									_0: _user$project$Draw$toForm(
										A2(addPos, _p12._0, _p16._0)),
									_1: model.drawing
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'KeyPress':
				return _user$project$Draw$inBounds(model.mousePos) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							drawing: {
								ctor: '::',
								_0: A2(_user$project$Draw$drawKey, model.mousePos, _p12._0),
								_1: model.drawing
							}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								draw: _elm_lang$core$Maybe$Nothing,
								drawing: _p17._1,
								redo: {ctor: '::', _0: _p17._0, _1: model.redo}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p18.ctor === '::') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								draw: _elm_lang$core$Maybe$Nothing,
								drawing: {ctor: '::', _0: _p18._0, _1: model.drawing},
								redo: _p18._1
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			default:
				return _user$project$Draw$init;
		}
	});
var _user$project$Draw$pos = _elm_lang$core$Native_Platform.incomingPort(
	'pos',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (top) {
			return A2(
				...
				A2(_elm_lang$core$Json_Decode$field, 'left', _elm_lang$core$Json_Decode$int));
		},
		A2(_elm_lang$core$Json_Decode$field, 'top', _elm_lang$core$Json_Decode$int)));
var _user$project$Draw$Model = F6(
	function (a, b, c, d, e, f) {
		return {draw: a, drawing: b, background: c, mousePos: d, pos: e, redo: f};
	});
var _user$project$Draw$Pos = F2(
	function (a, b) {
		return {top: a, left: b};
	});
var _user$project$Draw$Clear = {ctor: 'Clear'};
var _user$project$Draw$Redo = {ctor: 'Redo'};
var _user$project$Draw$Undo = {ctor: 'Undo'};
var _user$project$Draw$UpdatePos = function (a) {
	return {ctor: 'UpdatePos', _0: a};
};
var _user$project$Draw$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _user$project$Draw$DrawEnd = function (a) {
	return {ctor: 'DrawEnd', _0: a};
};
var _user$project$Draw$MouseTo = function (a) {
	return {ctor: 'MouseTo', _0: a};
};
var _user$project$Draw$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Mouse$moves(_user$project$Draw$MouseTo),
			_1: {
				ctor: '::',
				_0: _user$project$Mouse$ups(_user$project$Draw$DrawEnd),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$presses(_user$project$Draw$KeyPress),
					_1: {
						ctor: '::',
						_0: _user$project$Draw$pos(_user$project$Draw$UpdatePos),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Draw$DrawStart = function (a) {
	return {ctor: 'DrawStart', _0: a};
};
var _user$project$Draw$onMouseDown = A3(
	_elm_lang$html$Html_Events$onWithOptions,
	'mousedown',
	{stopPropagation: true, preventDefault: true},
	A2(_elm_lang$core$Json_Decode$map, _user$project$Draw$DrawStart, _user$project$Mouse$position));
var _user$project$Draw$view = function (model) {
	var drawing = function () {
		var _p19 = model.draw;
		if (_p19.ctor === 'Just') {
			return {
				ctor: '::',
				_0: _user$project$Draw$toForm(_p19._0),
				_1: model.drawing
			};
		} else {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Draw$onMouseDown,
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_evancz$elm_graphics$Element$layers(
							{
								...
								_1: {
									ctor: '::',
									_0: A3(_evancz$elm_graphics$Collage$collage, 400, 400, drawing),
									_1: {ctor: '[]'}
								}
							})),
					_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Draw$Clear),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Draw$Undo),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$disabled(
									_elm_lang$core$List$isEmpty(model.drawing)),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_user$project$Draw$Redo),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$disabled(
										_elm_lang$core$List$isEmpty(model.redo)),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Draw$main = _elm_lang$html$Html$program(
	{init: _user$project$Draw$init, update: _user$project$Draw$update, view: _user$project$Draw$view, subscriptions: _user$project$Draw$subscriptions})();

var Elm = {};
Elm['Draw'] = Elm['Draw'] || {};
if (typeof _user$project$Draw$main !== 'undefined') {
    _user$project$Draw$main(Elm['Draw'], 'Draw', undefined);
}
