...
var _robx$check$Draw$capturePointerDown = A2(_elm_lang$html$Html_Attributes$attribute, 'onpointerdown', 'event.target.setPointerCapture(event.pointerId);');
var _robx$check$Draw$targetValueAsNumber = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'target',
...
var _robx$check$Draw$toForm = F2(
	function (pen, ps) {
		var _p0 = ps;
		if ((_p0.ctor === '::') && (_p0._1.ctor === '[]')) {
			...
			return A2(
				...
				_robx$check$Draw$lineStyle(pen),
				_evancz$elm_graphics$Collage$path(ps));
		}
	});
var _robx$check$Draw$toCoord = function (_p1) {
	var _p2 = _p1;
	return {ctor: '_Tuple2', _0: _p2._0 - 200, _1: 200 - _p2._1};
};
var _robx$check$Draw$updatePen = F2(
	function (msg, pen) {
		var _p3 = msg;
...
var _robx$check$Draw$update = F2(
	function (msg, model) {
		var _p4 = msg;
		switch (_p4.ctor) {
			case 'DrawStart':
				var pos = _robx$check$Draw$toCoord(_p4._0);
				return {
					ctor: '_Tuple2',
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								drawing: {
									ctor: '::',
									_0: A2(_robx$check$Draw$toForm, model.pen, _p7._0),
									_1: model.drawing
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								drawing: {
									ctor: '::',
									_0: A3(_robx$check$Draw$drawKey, model.pen, _p8._0, _p4._0),
									_1: model.drawing
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							pen: A2(_robx$check$Draw$updatePen, _p4._0, model.pen)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _robx$check$Draw$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			draw: _elm_lang$core$Maybe$Nothing,
			drawing: {ctor: '[]'},
			background: A3(_evancz$elm_graphics$Element$image, flags.width, flags.height, flags.image),
			width: flags.width,
			height: flags.height,
...
var _robx$check$Draw$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {draw: a, drawing: b, background: c, width: d, height: e, pen: f, mousePos: g, redo: h};
	});
var _robx$check$Draw$Pen = F2(
	function (a, b) {
		return {color: a, width: b};
	});
var _robx$check$Draw$Flags = F3(
	function (a, b, c) {
		return {image: a, width: b, height: c};
	});
var _robx$check$Draw$PenMsg = function (a) {
	return {ctor: 'PenMsg', _0: a};
};
var _robx$check$Draw$Clear = {ctor: 'Clear'};
var _robx$check$Draw$Redo = {ctor: 'Redo'};
var _robx$check$Draw$Undo = {ctor: 'Undo'};
var _robx$check$Draw$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _robx$check$Draw$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$downs(_robx$check$Draw$KeyPress),
			_1: {ctor: '[]'}
		});
};
var _robx$check$Draw$MouseLeave = {ctor: 'MouseLeave'};
var _robx$check$Draw$onMouseLeave = A2(
	_elm_lang$html$Html_Events$on,
	'mouseleave',
	_elm_lang$core$Json_Decode$succeed(_robx$check$Draw$MouseLeave));
var _robx$check$Draw$DrawEnd = {ctor: 'DrawEnd'};
var _robx$check$Draw$onPointerUp = A3(
	_mpizenberg$elm_pointer_events$Pointer$onWithOptions,
	'pointerup',
	{stopPropagation: false, preventDefault: true},
	function (e) {
		return _robx$check$Draw$DrawEnd;
	});
var _robx$check$Draw$MoveTo = function (a) {
	return {ctor: 'MoveTo', _0: a};
};
var _robx$check$Draw$onPointerMove = _mpizenberg$elm_pointer_events$Pointer$onMove(
	function (e) {
		return _robx$check$Draw$MoveTo(e.pointer.offsetPos);
	});
var _robx$check$Draw$DrawStart = function (a) {
	return {ctor: 'DrawStart', _0: a};
};
var _robx$check$Draw$onPointerDown = A3(
	_mpizenberg$elm_pointer_events$Pointer$onWithOptions,
	'pointerdown',
	{stopPropagation: false, preventDefault: true},
	function (e) {
		return _robx$check$Draw$DrawStart(e.pointer.offsetPos);
	});
var _robx$check$Draw$PickWidth = function (a) {
	return {ctor: 'PickWidth', _0: a};
};
var _robx$check$Draw$widthInput = function (pen) {
	return A2(
							...
							_1: {
								...
								_0: A2(
									...
									A2(
										_elm_lang$core$Json_Decode$map,
										function (_p11) {
											return _robx$check$Draw$PenMsg(
												_robx$check$Draw$PickWidth(_p11));
										},
										_robx$check$Draw$targetValueAsNumber)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _robx$check$Draw$PickColor = function (a) {
	return {ctor: 'PickColor', _0: a};
};
var _robx$check$Draw$colorButton = F3(
		...
		return A2(
			_elm_lang$html$Html$button,
			{
				...
				_0: _elm_lang$html$Html_Events$onClick(
					_robx$check$Draw$PenMsg(
						_robx$check$Draw$PickColor(color))),
				_1: {
					ctor: '::',
...
var _robx$check$Draw$view = function (model) {
	var col = _robx$check$Draw$colorButton(model.pen);
	var drawing = function () {
		var _p12 = model.draw;
		if (_p12.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A2(_robx$check$Draw$toForm, model.pen, _p12._0),
				_1: model.drawing
			};
		} else {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _robx$check$Draw$onPointerDown,
					_1: {
						ctor: '::',
						_0: _robx$check$Draw$capturePointerDown,
						_1: {
							ctor: '::',
							_0: _robx$check$Draw$onPointerMove,
							_1: {
								ctor: '::',
								_0: _robx$check$Draw$onPointerUp,
								_1: {
									ctor: '::',
									_0: _robx$check$Draw$onMouseLeave,
									_1: {
										ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_robx$check$Draw$Clear),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_robx$check$Draw$Undo),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$disabled(
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_robx$check$Draw$Redo),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$disabled(
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _robx$check$Draw$widthInput(model.pen),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _robx$check$Draw$main = _elm_lang$html$Html$programWithFlags(
	{init: _robx$check$Draw$init, update: _robx$check$Draw$update, view: _robx$check$Draw$view, subscriptions: _robx$check$Draw$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (height) {
			return A2(
					...
					return A2(
						...
						function (width) {
							return _elm_lang$core$Json_Decode$succeed(
								{height: height, image: image, width: width});
						},
...
var Elm = {};
Elm['Draw'] = Elm['Draw'] || {};
if (typeof _robx$check$Draw$main !== 'undefined') {
    _robx$check$Draw$main(Elm['Draw'], 'Draw', undefined);
}
