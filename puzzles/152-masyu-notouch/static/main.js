...
var _robx$check$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _robx$check$Main$boxed = {
	ctor: '::',
...
var _robx$check$Main$normalize = function () {
...
var _robx$check$Main$Model = F4(
	function (a, b, c, d) {
		return {puzzle: a, code: b, result: c, mdl: d};
	});
var _robx$check$Main$Puzzle = F5(
	function (a, b, c, d, e) {
		return {name: a, codeDescription: b, code: c, codeLabel: d, valid: e};
	});
var _robx$check$Main$Flags = F5(
	function (a, b, c, d, e) {
		return {name: a, codeDescription: b, code: c, codeLabel: d, valid: e};
	});
var _robx$check$Main$ILX = function (a) {
	return {ctor: 'ILX', _0: a};
};
var _robx$check$Main$ZeroOne = function (a) {
	return {ctor: 'ZeroOne', _0: a};
};
var _robx$check$Main$Digits = function (a) {
	return {ctor: 'Digits', _0: a};
};
var _robx$check$Main$validatorDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (s) {
		var _p2 = s;
		switch (_p2) {
	...
	A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string));
var _robx$check$Main$init = function (flags) {
	var _p3 = A2(_elm_lang$core$Json_Decode$decodeValue, _robx$check$Main$validatorDecoder, flags.valid);
	if (_p3.ctor === 'Ok') {
		return {
			ctor: '_Tuple2',
			_0: {
				puzzle: {name: flags.name, codeDescription: flags.codeDescription, code: flags.code, codeLabel: flags.codeLabel, valid: _p3._0},
				code: '',
...
var _robx$check$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _robx$check$Main$NoOp = {ctor: 'NoOp'};
var _robx$check$Main$Check = {ctor: 'Check'};
var _robx$check$Main$CodeChange = function (a) {
	return {ctor: 'CodeChange', _0: a};
};
var _robx$check$Main$Wrong = {ctor: 'Wrong'};
var _robx$check$Main$Correct = {ctor: 'Correct'};
var _robx$check$Main$Valid = {ctor: 'Valid'};
var _robx$check$Main$Incomplete = {ctor: 'Incomplete'};
var _robx$check$Main$Invalid = function (a) {
	return {ctor: 'Invalid', _0: a};
};
var _robx$check$Main$validate = F2(
	function (v, s) {
		var norm = _robx$check$Main$normalize(s);
		var valDigits = function (n) {
			return (!A2(_elm_lang$core$String$all, _elm_lang$core$Char$isDigit, norm)) ? _robx$check$Main$Invalid('Invalid characters, digits only.') : ((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(norm),
				n) > 0) ? _robx$check$Main$Invalid(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Too long, want ',
					A2(
				...
				_elm_lang$core$String$length(norm),
				n) < 0) ? _robx$check$Main$Incomplete : _robx$check$Main$Valid));
		};
		var val01 = function (n) {
			var is01 = function (c) {
				var _p5 = c;
				switch (_p5.valueOf()) {
					case '0':
			...
			return (!A2(_elm_lang$core$String$all, is01, norm)) ? _robx$check$Main$Invalid('Invalid characters, 0/1 only.') : ((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(norm),
				n) > 0) ? _robx$check$Main$Invalid(
				A2(
					_elm_lang$core$Basics_ops['++'],
		...
		var valILX = function (n) {
			var isILX = function (c) {
				var _p6 = c;
				switch (_p6.valueOf()) {
					case 'L':
						return true;
			...
			return (!A2(_elm_lang$core$String$all, isILX, norm)) ? _robx$check$Main$Invalid('Invalid characters, ILX only.') : ((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(norm),
				n) > 0) ? _robx$check$Main$Invalid(
				A2(
					_elm_lang$core$Basics_ops['++'],
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(n),
						' letters'))) : ((_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$String$length(norm),
				n) < 0) ? _robx$check$Main$Incomplete : _robx$check$Main$Valid));
		};
		var val = function () {
			...
			switch (_p7.ctor) {
				case 'Digits':
					return valDigits(_p7._0);
				case 'ZeroOne':
					return val01(_p7._0);
				default:
					return valILX(_p7._0);
			}
		}();
		return {ctor: '_Tuple2', _0: norm, _1: val};
	});
var _robx$check$Main$update = F2(
	function (msg, model) {
		var _p8 = msg;
		switch (_p8.ctor) {
			case 'CodeChange':
			...
			case 'Check':
				var _p9 = A2(_robx$check$Main$validate, model.puzzle.valid, model.code);
				var norm = _p9._0;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							result: _elm_lang$core$Maybe$Just(
								_elm_lang$core$Native_Utils.eq(
									model.puzzle.code,
									_ktonon$elm_crypto$Crypto_Hash$sha256(norm)) ? _robx$check$Main$Correct : _robx$check$Main$Wrong)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return A3(_debois$elm_mdl$Material$update, _robx$check$Main$Mdl, _p8._0, model);
		}
	});
var _robx$check$Main$viewPuzzle = function (model) {
	var result = function () {
		var _p10 = model.result;
		if (_p10.ctor === 'Nothing') {
			return A2(
				_elm_lang$html$Html$span,
				{ctor: '[]'},
	...
	var _p11 = A2(_robx$check$Main$validate, puzzle.valid, model.code);
	var norm = _p11._0;
	var valid = _p11._1;
	var err = function () {
		var _p12 = valid;
		if (_p12.ctor === 'Invalid') {
	...
	var submit = _elm_lang$core$Native_Utils.eq(valid, _robx$check$Main$Valid) ? {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_robx$check$Main$Check),
		_1: {ctor: '[]'}
	} : {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onSubmit(_robx$check$Main$NoOp),
		_1: {ctor: '[]'}
	};
	return A2(
		_debois$elm_mdl$Material_Options$div,
		_robx$check$Main$boxed,
		{
			ctor: '::',
			_0: A2(
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onInput(_robx$check$Main$CodeChange),
													_1: {
														ctor: '::',
								...
								_0: A5(
									...
									model.mdl,
									{
										...
										_0: _debois$elm_mdl$Material_Options$disabled(
											!_elm_lang$core$Native_Utils.eq(valid, _robx$check$Main$Valid)),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
...
var _robx$check$Main$view = function (model) {
	return _robx$check$Main$viewPuzzle(model);
};
var _robx$check$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _robx$check$Main$init,
		update: _robx$check$Main$update,
		view: _elm_lang$html$Html_Lazy$lazy(_robx$check$Main$view),
		subscriptions: _robx$check$Main$subscriptions
	})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (code) {
									...
									return A2(
										...
										function (valid) {
											return _elm_lang$core$Json_Decode$succeed(
												{code: code, codeDescription: codeDescription, codeLabel: codeLabel, name: name, valid: valid});
										},
										A2(_elm_lang$core$Json_Decode$field, 'valid', _elm_lang$core$Json_Decode$value));
								},
								A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'codeLabel', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'codeDescription', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'code', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _robx$check$Main$main !== 'undefined') {
    _robx$check$Main$main(Elm['Main'], 'Main', undefined);
}
