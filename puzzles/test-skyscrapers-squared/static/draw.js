...
var _elm_lang$virtual_dom$VirtualDom$defaultOptions = {stopPropagation: false, preventDefault: false, capturePointer: false, releasePointer: false};
...
var _elm_lang$virtual_dom$VirtualDom$Options = F4(
	function (a, b, c, d) {
		return {stopPropagation: a, preventDefault: b, capturePointer: c, releasePointer: d};
	});
...
var _elm_lang$html$Html_Events$Options = F4(
	function (a, b, c, d) {
		return {stopPropagation: a, preventDefault: b, capturePointer: c, releasePointer: d};
	});
...
var _mpizenberg$elm_pointer_events$Mouse$offsetPosDecoder = A3(
...
var _mpizenberg$elm_pointer_events$Mouse$clientPosDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
...
var _mpizenberg$elm_pointer_events$Mouse$stopOptions = {stopPropagation: true, preventDefault: true, capturePointer: false, releasePointer: false};
var _mpizenberg$elm_pointer_events$Mouse$Event = F3(
	function (a, b, c) {
		return {key: a, clientPos: b, offsetPos: c};
	});
var _mpizenberg$elm_pointer_events$Mouse$Keys = F3(
	function (a, b, c) {
		return {alt: a, ctrl: b, shift: c};
	});
var _mpizenberg$elm_pointer_events$Mouse$keyDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_mpizenberg$elm_pointer_events$Mouse$Keys,
...
var _mpizenberg$elm_pointer_events$Mouse$eventDecoder = A4(_elm_lang$core$Json_Decode$map3, _mpizenberg$elm_pointer_events$Mouse$Event, _mpizenberg$elm_pointer_events$Mouse$keyDecoder, _mpizenberg$elm_pointer_events$Mouse$clientPosDecoder, _mpizenberg$elm_pointer_events$Mouse$offsetPosDecoder);
...
var _mpizenberg$elm_pointer_events$Pointer$stopOptions = {stopPropagation: true, preventDefault: true, capturePointer: false, releasePointer: false};
var _mpizenberg$elm_pointer_events$Pointer$Event = F3(
	function (a, b, c) {
		return {isPrimary: a, pointerId: b, pointer: c};
	});
var _mpizenberg$elm_pointer_events$Pointer$eventDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
...
var _user$project$Draw$targetValueAsNumber = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'target',
...
var _user$project$Draw$lineStyle = function (pen) {
	var style = _evancz$elm_graphics$Collage$defaultLine;
	return _elm_lang$core$Native_Utils.update(
		style,
		{color: pen.color, width: pen.width, cap: _evancz$elm_graphics$Collage$Round});
};
var _user$project$Draw$drawKey = F3(
	function (pen, p, k) {
		return A2(
...
var _user$project$Draw$toForm = F2(
	function (pen, ps) {
		var _p0 = ps;
		if ((_p0.ctor === '::') && (_p0._1.ctor === '[]')) {
			return A2(
				...
				A2(
					...
					pen.color,
					_evancz$elm_graphics$Collage$circle(pen.width / 2)));
		} else {
			return A2(
				_evancz$elm_graphics$Collage$traced,
				_user$project$Draw$lineStyle(pen),
				_evancz$elm_graphics$Collage$path(ps));
		}
	});
var _user$project$Draw$toCoord = function (_p1) {
	var _p2 = _p1;
	return {ctor: '_Tuple2', _0: _p2._0 - 200, _1: 200 - _p2._1};
};
var _user$project$Draw$updatePen = F2(
	function (msg, pen) {
		var _p3 = msg;
		if (_p3.ctor === 'PickColor') {
			return _elm_lang$core$Native_Utils.update(
				pen,
				{color: _p3._0});
		} else {
...
var _user$project$Draw$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			case 'DrawStart':
				var pos = _user$project$Draw$toCoord(_p4._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							mousePos: _elm_lang$core$Maybe$Just(pos),
			...
			case 'MoveTo':
				var addDedup = F2(
					function (p, ps) {
						var _p5 = ps;
						if (_p5.ctor === '::') {
							return _elm_lang$core$Native_Utils.eq(_p5._0, p) ? ps : {ctor: '::', _0: p, _1: ps};
						} else {
							return {
								ctor: '::',
								_0: p,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								drawing: {
									ctor: '::',
									_0: A2(_user$project$Draw$toForm, model.pen, _p7._0),
									_1: model.drawing
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
			...
			case 'MouseLeave':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{mousePos: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'KeyPress':
				var _p8 = model.mousePos;
				if (_p8.ctor === 'Just') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								drawing: {
									ctor: '::',
									_0: A3(_user$project$Draw$drawKey, model.pen, _p8._0, _p4._0),
									_1: model.drawing
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								draw: _elm_lang$core$Maybe$Nothing,
								drawing: _p9._1,
								redo: {ctor: '::', _0: _p9._0, _1: model.redo}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
				...
				if (_p10.ctor === '::') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								draw: _elm_lang$core$Maybe$Nothing,
								drawing: {ctor: '::', _0: _p10._0, _1: model.drawing},
								redo: _p10._1
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							pen: A2(_user$project$Draw$updatePen, _p4._0, model.pen)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Draw$init = {
	...
	_0: {
		...
		pen: {color: _elm_lang$core$Color$red, width: 5},
		mousePos: _elm_lang$core$Maybe$Nothing,
		redo: {ctor: '[]'}
	},
	_1: _elm_lang$core$Platform_Cmd$none
...
var _user$project$Draw$Model = F6(
	function (a, b, c, d, e, f) {
		return {draw: a, drawing: b, background: c, pen: d, mousePos: e, redo: f};
	});
var _user$project$Draw$Pen = F2(
	function (a, b) {
		return {color: a, width: b};
	});
var _user$project$Draw$PenMsg = function (a) {
	return {ctor: 'PenMsg', _0: a};
};
...
var _user$project$Draw$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Draw$KeyPress),
			_1: {ctor: '[]'}
		});
};
var _user$project$Draw$MouseLeave = {ctor: 'MouseLeave'};
var _user$project$Draw$onMouseLeave = A2(
	_elm_lang$html$Html_Events$on,
	'mouseleave',
	_elm_lang$core$Json_Decode$succeed(_user$project$Draw$MouseLeave));
var _user$project$Draw$DrawEnd = {ctor: 'DrawEnd'};
var _user$project$Draw$onPointerUp = A3(
	_mpizenberg$elm_pointer_events$Pointer$onWithOptions,
	'pointerup',
	{stopPropagation: false, preventDefault: true, capturePointer: false, releasePointer: true},
	function (e) {
		return _user$project$Draw$DrawEnd;
	});
var _user$project$Draw$MoveTo = function (a) {
	return {ctor: 'MoveTo', _0: a};
};
var _user$project$Draw$onPointerMove = _mpizenberg$elm_pointer_events$Pointer$onMove(
	function (e) {
		return _user$project$Draw$MoveTo(e.pointer.offsetPos);
	});
var _user$project$Draw$DrawStart = function (a) {
	return {ctor: 'DrawStart', _0: a};
};
var _user$project$Draw$onPointerDown = A3(
	_mpizenberg$elm_pointer_events$Pointer$onWithOptions,
	'pointerdown',
	{stopPropagation: false, preventDefault: true, capturePointer: true, releasePointer: false},
	function (e) {
		return _user$project$Draw$DrawStart(e.pointer.offsetPos);
	});
var _user$project$Draw$PickWidth = function (a) {
	return {ctor: 'PickWidth', _0: a};
};
var _user$project$Draw$widthInput = function (pen) {
	return A2(
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Attributes$value(
								_elm_lang$core$Basics$toString(pen.width)),
							_1: {
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html_Events$on,
									...
									A2(
										_elm_lang$core$Json_Decode$map,
										function (_p11) {
											return _user$project$Draw$PenMsg(
												_user$project$Draw$PickWidth(_p11));
										},
										_user$project$Draw$targetValueAsNumber)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Draw$PickColor = function (a) {
	return {ctor: 'PickColor', _0: a};
};
var _user$project$Draw$colorButton = F3(
	function (pen, color, label) {
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_user$project$Draw$PenMsg(
						_user$project$Draw$PickColor(color))),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$disabled(
						_elm_lang$core$Native_Utils.eq(pen.color, color)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _user$project$Draw$view = function (model) {
	var col = _user$project$Draw$colorButton(model.pen);
	var drawing = function () {
		var _p12 = model.draw;
		if (_p12.ctor === 'Just') {
			return {
				ctor: '::',
				_0: A2(_user$project$Draw$toForm, model.pen, _p12._0),
				_1: model.drawing
			};
		} else {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Draw$onPointerDown,
					_1: {
						ctor: '::',
						_0: _user$project$Draw$onPointerMove,
						_1: {
							ctor: '::',
							_0: _user$project$Draw$onPointerUp,
							_1: {
								ctor: '::',
								_0: _user$project$Draw$onMouseLeave,
								_1: {
									ctor: '::',
						...
						_evancz$elm_graphics$Element$layers(
							{
								...
								_1: {
									...
									_0: A3(
										...
										400,
										400,
										_elm_lang$core$List$reverse(drawing)),
									_1: {ctor: '[]'}
								}
							})),
					_1: {ctor: '[]'}
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: A2(col, _elm_lang$core$Color$red, 'Red'),
							_1: {
								ctor: '::',
								_0: A2(col, _elm_lang$core$Color$green, 'Green'),
								_1: {
									ctor: '::',
									_0: A2(col, _elm_lang$core$Color$blue, 'Blue'),
									_1: {
										ctor: '::',
										_0: A2(col, _elm_lang$core$Color$black, 'Black'),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Draw$widthInput(model.pen),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
