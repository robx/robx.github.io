...
var _robx$check$Draw$init = {
	ctor: '_Tuple2',
	_0: {
		draw: _elm_lang$core$Maybe$Nothing,
		drawing: {ctor: '[]'},
		background: A3(_evancz$elm_graphics$Element$image, 400, 400, 'nurikabe-skyscrapers.png'),
...
var _robx$check$Draw$main = _elm_lang$html$Html$program(
