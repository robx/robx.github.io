	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							result: A2(
								...
								_ktonon$elm_crypto$Crypto_Hash$sha256(norm),
								_elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.eq(
										model.puzzle.code,
			...
			case 'NoOp':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return A3(_debois$elm_mdl$Material$update, _robx$check$Main$Mdl, _p2._0, model);
		}
	});
...
var _robx$check$Main$fillomino = F2(
	function (n, s) {
		var norm = _robx$check$Main$normalize(s);
		var v = (!A2(_elm_lang$core$String$all, _elm_lang$core$Char$isDigit, norm)) ? _robx$check$Main$Invalid('Invalid characters, digits only.') : ((_elm_lang$core$Native_Utils.cmp(
...
var _robx$check$Main$fillo = {
	...
	valid: _robx$check$Main$fillomino(20)
};
var _robx$check$Main$sky = {
...
var _robx$check$Main$zeroone = F2(
	function (n, s) {
		var is01 = function (c) {
			var _p8 = c;
			switch (_p8.valueOf()) {
		...
		var norm = _robx$check$Main$normalize(s);
		var v = (!A2(_elm_lang$core$String$all, is01, norm)) ? _robx$check$Main$Invalid('Invalid characters, 0/1 only.') : ((_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$String$length(norm),
			n) > 0) ? _robx$check$Main$Invalid(
			A2(
				_elm_lang$core$Basics_ops['++'],
...
var _robx$check$Main$nurisky = {
	name: 'Puzzle 151: Skyscraper-Nurikabe',
	codeDescription: '\n        Enter the marked rows from left to right, 1 for shaded cells, 0 for unshaded cells.\n        ',
	codeLabel: '20 times 0,1',
	code: '259b17bf162d3960e6313b2726a2e204ec9d6e87dee2af61147ad02a3104ef5f',
	valid: _robx$check$Main$zeroone(20)
};
var _robx$check$Main$init = {
	ctor: '_Tuple2',
	_0: {puzzle: _robx$check$Main$nurisky, code: '', result: _elm_lang$core$Maybe$Nothing, mdl: _debois$elm_mdl$Material$model},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _robx$check$Main$main = _elm_lang$html$Html$program(
	{
