...
var _user$project$Card$superset = function (cards) {
	var _p0 = cards;
	if (((((_p0.ctor === '::') && (_p0._1.ctor === '::')) && (_p0._1._1.ctor === '::')) && (_p0._1._1._1.ctor === '::')) && (_p0._1._1._1._1.ctor === '[]')) {
		var _p4 = _p0._1._1._1._0;
		var _p3 = _p0._1._1._0;
		var _p2 = _p0._1._0;
		var _p1 = _p0._0;
		var miss = F2(
			function (a, b) {
				return A2(_elm_lang$core$Basics_ops['%'], (0 - a) - b, 3);
			});
		var missingCard = F2(
			function (a, b) {
				return {
					color: A2(miss, a.color, b.color),
					shape: A2(miss, a.shape, b.shape),
					count: A2(miss, a.count, b.count),
					fill: A2(miss, a.fill, b.fill)
				};
			});
		return _elm_lang$core$Native_Utils.eq(
			A2(missingCard, _p1, _p2),
			A2(missingCard, _p3, _p4)) || (_elm_lang$core$Native_Utils.eq(
			A2(missingCard, _p1, _p3),
			A2(missingCard, _p2, _p4)) || _elm_lang$core$Native_Utils.eq(
			A2(missingCard, _p1, _p4),
			A2(missingCard, _p2, _p3)));
	} else {
		return false;
	}
};
var _user$project$Card$set = function (cards) {
		...
		return A3(
			...
			_elm_lang$core$List$length(
				_elm_community$list_extra$List_Extra$unique(
					A2(_elm_lang$core$List$map, prop, cards))));
	};
	return _elm_lang$core$Native_Utils.eq(
...
var _user$project$Card$fromInt = function (x) {
	var b1 = (x / 3) | 0;
	var a2 = A2(_elm_lang$core$Basics_ops['%'], b1, 3);
	var b2 = (b1 / 3) | 0;
	var a3 = A2(_elm_lang$core$Basics_ops['%'], b2, 3);
	var b3 = (b2 / 3) | 0;
	var a4 = A2(_elm_lang$core$Basics_ops['%'], b3, 3);
	var a1 = A2(_elm_lang$core$Basics_ops['%'], x, 3);
	return {color: a1, count: a2, shape: a3, fill: a4};
};
var _user$project$Card$Card = F4(
	function (a, b, c, d) {
		return {color: a, count: b, shape: c, fill: d};
	});

var _user$project$D$ptos = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$core$Basics_ops['++'],
	...
	function (c, ps) {
		return A2(
			...
			' ',
			{
				ctor: '::',
				_0: c,
				_1: A2(_elm_lang$core$List$map, _user$project$D$ptos, ps)
			});
	});
var _user$project$D$dl = function (p) {
	return A2(
		_user$project$D$dd,
		'l',
		{
...
var _user$project$D$dm = function (p) {
	return A2(
		_user$project$D$dd,
		'm',
		{
...
var _user$project$D$dZ = A2(
	_user$project$D$dd,
	'Z',
	{ctor: '[]'});
var _user$project$D$dA = F4(
	function (p, x, q, r) {
		return A2(
			_elm_lang$core$String$join,
			' ',
			{
				...
				_1: {
					ctor: '::',
					_0: _user$project$D$ptos(p),
					_1: {
						ctor: '::',
						_0: _elm_lang$core$Basics$toString(x),
						_1: {
							ctor: '::',
							_0: _user$project$D$ptos(q),
							_1: {
								ctor: '::',
								_0: _user$project$D$ptos(r),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Game$countSupersets = function (g) {
...
var _user$project$Game$superset = F2(
	function (g, ps) {
		var cs = A2(
			_elm_lang$core$List$filterMap,
			A2(_elm_lang$core$Basics$flip, _elm_lang$core$Dict$get, g.table),
			ps);
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$length(cs),
			4) && _user$project$Card$superset(cs);
	});
var _user$project$Game$set = F2(
	function (g, ps) {
		...
		return _elm_lang$core$Native_Utils.eq(
			...
			3) && _user$project$Card$set(cs);
	});
var _user$project$Game$grid = function (cols) {
	return A2(
		_elm_lang$core$List$concatMap,
		function (x) {
			return A2(
		...
		var remove1 = F2(
			function (pos, g) {
				return _elm_lang$core$Native_Utils.update(
					g,
					{
						table: A2(_elm_lang$core$Dict$remove, pos, g.table)
					});
			});
		var deal1 = F2(
			function (pos, g) {
...
var _user$project$Game$deck = A2(
	...
	A2(_elm_lang$core$List$range, 0, 80));
var _user$project$Game$shuffled = _elm_community$random_extra$Random_List$shuffle(_user$project$Game$deck);
var _user$project$Game$posEmpty = F2(
	function (g, p) {
		return !A2(_elm_lang$core$Dict$member, p, g.table);
	});
var _user$project$Game$deckEmpty = function (g) {
	return _elm_lang$core$List$isEmpty(g.deck);
};
var _user$project$Game$Game = F3(
	function (a, b, c) {
		return {deck: a, table: b, type_: c};
	});
var _user$project$Game$SuperSet = {ctor: 'SuperSet'};
var _user$project$Game$take = F2(
	function (g, ps) {
		var s = _elm_lang$core$Native_Utils.eq(g.type_, _user$project$Game$SuperSet) ? A2(_user$project$Game$superset, g, ps) : A2(_user$project$Game$set, g, ps);
		return s ? {
			ctor: '_Tuple2',
			_0: true,
			_1: _elm_lang$core$Native_Utils.update(
				g,
				{
					table: A3(
						...
						g.table,
						A2(_elm_lang$core$List$map, _elm_lang$core$Dict$remove, ps))
				})
...
var _user$project$Game$gaps = function (g) {
	return A2(
		...
		_elm_lang$core$Native_Utils.eq(g.type_, _user$project$Game$ClassicSet) ? _user$project$Game$standardGrid : _user$project$Game$superGrid);
};
var _user$project$Game$Move = function (a) {
	return {ctor: 'Move', _0: a};
};
var _user$project$Game$compact = function (g) {
	var ms = _user$project$Game$compactMoves(g);
	var md = _elm_lang$core$Dict$fromList(ms);
	var move = function (p) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			p,
			A2(_elm_lang$core$Dict$get, p, md));
	};
	return {
		ctor: '_Tuple2',
		_0: A2(
			_user$project$Game$apply,
			_user$project$Game$Move(ms),
			g),
		_1: move
	};
};
var _user$project$Game$Set = function (a) {
	return {ctor: 'Set', _0: a};
};
var _user$project$Game$Deal = function (a) {
	return {ctor: 'Deal', _0: a};
};
var _user$project$Game$dealAction = function (g) {
	return _user$project$Game$Deal(
		_user$project$Game$gaps(g));
};
var _user$project$Game$deal = function (g) {
	return A2(
		_user$project$Game$apply,
		_user$project$Game$dealAction(g),
		g);
};
var _user$project$Game$init = F2(
	function ($short, $super) {
		return A2(
			_elm_lang$core$Random$map,
			...
			A2(
				...
				function (d) {
					return {
						deck: d,
						table: _elm_lang$core$Dict$empty,
						type_: $super ? _user$project$Game$SuperSet : _user$project$Game$ClassicSet
					};
				},
				A2(
					_elm_lang$core$Random$map,
					$short ? _elm_lang$core$List$drop(60) : function (x) {
						return x;
					},
...
var _user$project$Game$dealMoreAction = function () {
	...
	return function (_p22) {
		return _user$project$Game$Deal(
			col(
				_user$project$Game$columns(_p22)));
	};
}();
var _user$project$Game$dealMore = function (g) {
	return A2(
		_user$project$Game$apply,
		_user$project$Game$dealMoreAction(g),
		g);
};
...
var _user$project$SvgSet$dropShadow = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$id('dropshadow'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$in_('SourceAlpha'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$stdDeviation('1'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$dx('2'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$dy('2'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$result('offsetblur'),
							_1: {ctor: '[]'}
						}
					}
				},
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$type_('linear'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$slope('0.5'),
									_1: {ctor: '[]'}
								}
							},
							{ctor: '[]'}),
...
var _user$project$SvgSet$shades = function () {
	var s = A2(
		_elm_lang$core$String$join,
		' ',
		{
			ctor: '::',
			_0: _user$project$D$dM(
				{ctor: '_Tuple2', _0: -17, _1: 8}),
			_1: {
				ctor: '::',
				_0: _user$project$D$dl(
					{ctor: '_Tuple2', _0: 0, _1: -16}),
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$d(s),
			_1: {ctor: '[]'}
		},
		{ctor: '[]'});
}();
var _user$project$SvgSet$squiggled = A2(
	_elm_lang$core$String$join,
	' ',
	{
		ctor: '::',
		_0: _user$project$D$dM(
			{ctor: '_Tuple2', _0: -18, _1: 0}),
		_1: {
			ctor: '::',
			_0: A3(
				_user$project$D$dC,
				{ctor: '_Tuple2', _0: -18, _1: -4},
				{ctor: '_Tuple2', _0: -12, _1: -6.5},
				{ctor: '_Tuple2', _0: -10, _1: -6.5}),
			_1: {
				ctor: '::',
				_0: A3(
					_user$project$D$dC,
					{ctor: '_Tuple2', _0: -3, _1: -6.5},
					{ctor: '_Tuple2', _0: 1, _1: -2.5},
					{ctor: '_Tuple2', _0: 7, _1: -2.5}),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$D$dC,
						{ctor: '_Tuple2', _0: 11, _1: -2.5},
						{ctor: '_Tuple2', _0: 13, _1: -6},
						{ctor: '_Tuple2', _0: 15, _1: -6}),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$D$dS,
...
var _user$project$SvgSet$squiggle = A2(
	_elm_lang$svg$Svg$path,
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$d(_user$project$SvgSet$squiggled),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$SvgSet$oval = A2(
	_elm_lang$svg$Svg$rect,
	{
		ctor: '::',
	...
	{ctor: '[]'});
var _user$project$SvgSet$diamond = A2(
	_elm_lang$svg$Svg$polygon,
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$points('-18,0 0,6 18,0 0,-6'),
		_1: {ctor: '[]'}
	},
	{ctor: '[]'});
var _user$project$SvgSet$lens = A2(
	_elm_lang$svg$Svg$path,
	{
		ctor: '::',
	...
	{ctor: '[]'});
var _user$project$SvgSet$ellipse = A2(
	_elm_lang$svg$Svg$ellipse,
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$rx('18'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$ry('6'),
					_1: {ctor: '[]'}
	...
	{ctor: '[]'});
var _user$project$SvgSet$rectangle = A2(
	_elm_lang$svg$Svg$rect,
	{
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$x('-18'),
					...
					_0: A2(
						_elm_lang$svg$Svg$g,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$strokeWidth('0.3'),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							ctor: '::',
							_0: _user$project$SvgSet$shades,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
...
var _user$project$SvgSet$clipPaths = function (st) {
	var cp = function (d) {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$SvgSet$lookup, st.shapes, d),
				_1: {ctor: '[]'}
			});
	};
	return A2(
...
var _user$project$SvgSet$svgDefs = function (st) {
	return A2(
		_elm_lang$svg$Svg$defs,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$SvgSet$dropShadow,
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {style: a, page: b};
	});
var _user$project$Main$Style = F2(
	function (a, b) {
		return {style: a, layout: b};
	});
...
var _user$project$Main$Ignore = {ctor: 'Ignore'};
				...
				var task = A2(
					...
					function (now) {
						return A2(
							_elm_lang$core$Task$andThen,
							function (_p1) {
								return _elm_lang$core$Task$succeed(now);
							},
							_elm_lang$core$Process$sleep(time));
					},
					_elm_lang$core$Time$now);
				return A2(_elm_lang$core$Task$perform, msg, task);
			});
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'StartGame':
			...
			case 'Choose':
				var _p4 = _p2._0;
				if (A2(_user$project$Game$posEmpty, model.game, _p4)) {
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				} else {
					if (A2(_elm_lang$core$List$member, _p4, model.selected)) {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									selected: A2(_elm_community$list_extra$List_Extra$remove, _p4, model.selected)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						if (_elm_lang$core$Native_Utils.cmp(
							...
							_user$project$Game$setSize(model.game) - 1) < 0) {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										selected: {ctor: '::', _0: _p4, _1: model.selected}
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						} else {
							var _p3 = A2(
								_user$project$Game$take,
								model.game,
								{ctor: '::', _0: _p4, _1: model.selected});
							var isset = _p3._0;
							var newgame = _p3._1;
							if (isset) {
			...
			case 'Deal':
				var _p5 = _user$project$Game$compact(model.game);
				var gamecpct = _p5._0;
				var moves = _p5._1;
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$viewGame = F2(
	function (style, model) {
		var trans = function (_p7) {
			var _p8 = _p7;
			var y = (_elm_lang$core$Basics$toFloat(_p8._1) + 0.5) * (10 + style.layout.h);
			var x = (_elm_lang$core$Basics$toFloat(_p8._0) + 0.5) * (10 + style.layout.w);
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'translate(',
				A2(
		...
		var more = function () {
			...
			return A2(
				...
				{
					ctor: '::',
					_0: style.layout.button(text),
					_1: {ctor: '[]'}
				});
		}();
		var viewBox = function () {
			var height = (style.layout.h + 10) * 3;
			var width = (style.layout.w + 10) * (_elm_lang$core$Basics$toFloat(cols) + 1);
			return A2(
				_elm_lang$core$Basics_ops['++'],
				'0 0 ',
				A2(
			...
			return A2(
				_elm_lang$svg$Svg$g,
				{
					...
					_1: {
						...
						_0: _elm_lang$svg$Svg_Events$onClick(
							_user$project$Main$Choose(_p12)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$style('cursor: pointer;'),
							_1: {ctor: '[]'}
				...
				},
				{
					...
					_0: A4(
						...
						style.layout,
						style.style,
						A2(_elm_lang$core$List$member, _p12, model.selected),
						_p11._1),
					_1: {ctor: '[]'}
				});
		};
		...
		return A2(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'background', _1: style.style.table},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
			...
			{
				ctor: '::',
				_0: _user$project$SvgSet$svgDefs(style.style),
	...
	function (msg, model) {
		...
		switch (_p13.ctor) {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_0: A2(
								...
								A2(_user$project$Game$init, _p13._0, _p13._1)),
							_1: {
								ctor: '::',
			...
			case 'NewGame':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							page: _user$project$Main$Play(
								_user$project$Main$initGame(_p13._0))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'GameOver':
				var _p14 = A3(_user$project$Main$score, _p13._0, _p13._1, _p13._2);
				var secs = _p14._0;
				var msg = _p14._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				var _p15 = model.page;
				if (_p15.ctor === 'Play') {
					var _p16 = A2(_user$project$Main$updateGame, msg, _p15._0);
					var updgame = _p16._0;
					var cmd = _p16._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								page: _user$project$Main$Play(updgame)
							}),
						_1: cmd
					};
				} else {
					return _elm_lang$core$Native_Utils.crashCase(
						'Main',
						{
							...
							end: {line: 257, column: 44}
						},
						_p15)('bad state');
				}
		}
	});
var _user$project$Main$Go = F2(
	function (a, b) {
		return {ctor: 'Go', _0: a, _1: b};
	});
var _user$project$Main$viewStart = F2(
	function (style, msg) {
		var trd = function (_p18) {
			var _p19 = _p18;
			return _p19._2;
		};
		var snd = function (_p20) {
			var _p21 = _p20;
			return _p21._1;
		};
		var fst = function (_p22) {
			var _p23 = _p22;
			return _p23._0;
		};
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_1: {
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background', _1: model.style.style.table},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: function () {
				var _p25 = model.page;
				if (_p25.ctor === 'Start') {
					return A2(_user$project$Main$viewStart, model.style, _p25._0);
				} else {
					return A2(_user$project$Main$viewGame, model.style, _p25._0);
				}
			}(),
			_1: {ctor: '[]'}
		});
...
var _user$project$Main$Modified = {ctor: 'Modified'};
var _user$project$Main$Classic = {ctor: 'Classic'};
var _user$project$Main$parseStyle = function (loc) {
	var _p26 = A2(
		_evancz$url_parser$UrlParser$parseHash,
		A2(
			_evancz$url_parser$UrlParser_ops['<?>'],
			_evancz$url_parser$UrlParser$top,
			_evancz$url_parser$UrlParser$stringParam('style')),
		loc);
	if (_p26.ctor === 'Nothing') {
		return _user$project$Main$Square;
	} else {
		var _p27 = _p26._0;
		if (_p27.ctor === 'Nothing') {
			...
			switch (_p28) {
				case 'square':
					return _user$project$Main$Square;
				case 'classic':
					return _user$project$Main$Classic;
				case 'modified':
					return _user$project$Main$Modified;
				default:
					return _user$project$Main$Square;
			}
		}
...
var _user$project$Main$init = function (loc) {
	return {
		ctor: '_Tuple2',
		_0: {
			style: _user$project$Main$toStyle(
				_user$project$Main$parseStyle(loc)),
			page: _user$project$Main$Start(_elm_lang$core$Maybe$Nothing)
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Main$main = A2(
	...
	_elm_lang$core$Basics$always(_user$project$Main$Ignore),
	{
