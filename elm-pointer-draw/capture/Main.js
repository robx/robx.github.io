...
var _mpizenberg$elm_mouse_events$Mouse$offsetPosDecoder = A3(
...
var _mpizenberg$elm_mouse_events$Mouse$clientPosDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	F2(
		function (v0, v1) {
			return {ctor: '_Tuple2', _0: v0, _1: v1};
...
var _mpizenberg$elm_mouse_events$Mouse$stopOptions = function () {
	var defaultOptions = _elm_lang$html$Html_Events$defaultOptions;
	return _elm_lang$core$Native_Utils.update(
		defaultOptions,
		{stopPropagation: true, preventDefault: true});
}();
var _mpizenberg$elm_mouse_events$Mouse$Event = F3(
	function (a, b, c) {
		return {key: a, clientPos: b, offsetPos: c};
	});
var _mpizenberg$elm_mouse_events$Mouse$Keys = F3(
	function (a, b, c) {
		return {alt: a, ctrl: b, shift: c};
	});
var _mpizenberg$elm_mouse_events$Mouse$keyDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_mpizenberg$elm_mouse_events$Mouse$Keys,
...
var _mpizenberg$elm_mouse_events$Mouse$eventDecoder = A4(_elm_lang$core$Json_Decode$map3, _mpizenberg$elm_mouse_events$Mouse$Event, _mpizenberg$elm_mouse_events$Mouse$keyDecoder, _mpizenberg$elm_mouse_events$Mouse$clientPosDecoder, _mpizenberg$elm_mouse_events$Mouse$offsetPosDecoder);
var _mpizenberg$elm_mouse_events$Mouse$onWithOptions = F3(
	function (event, options, tag) {
		return A3(
			_elm_lang$html$Html_Events$onWithOptions,
			event,
			options,
			A2(_elm_lang$core$Json_Decode$map, tag, _mpizenberg$elm_mouse_events$Mouse$eventDecoder));
	});
var _mpizenberg$elm_mouse_events$Mouse$onDown = A2(_mpizenberg$elm_mouse_events$Mouse$onWithOptions, 'mousedown', _mpizenberg$elm_mouse_events$Mouse$stopOptions);
var _mpizenberg$elm_mouse_events$Mouse$onMove = A2(_mpizenberg$elm_mouse_events$Mouse$onWithOptions, 'mousemove', _mpizenberg$elm_mouse_events$Mouse$stopOptions);
var _mpizenberg$elm_mouse_events$Mouse$onUp = A2(_mpizenberg$elm_mouse_events$Mouse$onWithOptions, 'mouseup', _mpizenberg$elm_mouse_events$Mouse$stopOptions);

var _mpizenberg$elm_pointer_events$Pointer$stopOptions = function () {
	var defaultOptions = _elm_lang$html$Html_Events$defaultOptions;
	return _elm_lang$core$Native_Utils.update(
		defaultOptions,
		{stopPropagation: true, preventDefault: true});
...
var _mpizenberg$elm_pointer_events$Pointer$eventDecoder = A4(
	...
	_mpizenberg$elm_mouse_events$Mouse$eventDecoder);
...
var _robx$elm_pointer_draw$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _robx$elm_pointer_draw$Main$lineStyle = function () {
...
var _robx$elm_pointer_draw$Main$toForm = function (ps) {
	var _p0 = ps;
	if ((_p0.ctor === '::') && (_p0._1.ctor === '[]')) {
		...
		return A2(
			...
			_robx$elm_pointer_draw$Main$lineStyle,
			_evancz$elm_graphics$Collage$path(ps));
	}
};
var _robx$elm_pointer_draw$Main$toCoord = function (_p1) {
	var _p2 = _p1;
	return {ctor: '_Tuple2', _0: _p2._0 - 200, _1: 200 - _p2._1};
};
var _robx$elm_pointer_draw$Main$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'DrawStart':
				var pos = _robx$elm_pointer_draw$Main$toCoord(_p3._0);
				return {
					ctor: '_Tuple2',
			...
			case 'DrawTo':
				var addDedup = F2(
					function (p, ps) {
						var _p4 = ps;
						if (_p4.ctor === '::') {
							return _elm_lang$core$Native_Utils.eq(_p4._0, p) ? ps : {ctor: '::', _0: p, _1: ps};
						} else {
							return {
								ctor: '::',
								_0: p,
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								...
								drawing: {
									ctor: '::',
									_0: _robx$elm_pointer_draw$Main$toForm(_p6._0),
									_1: model.drawing
								}
							}),
						_1: _elm_lang$core$Platform_Cmd$none
...
var _robx$elm_pointer_draw$Main$init = {
	ctor: '_Tuple2',
	_0: {
		draw: _elm_lang$core$Maybe$Nothing,
		drawing: {ctor: '[]'}
...
var _robx$elm_pointer_draw$Main$Model = F2(
	function (a, b) {
		return {draw: a, drawing: b};
	});
var _robx$elm_pointer_draw$Main$DrawEnd = {ctor: 'DrawEnd'};
var _robx$elm_pointer_draw$Main$onPointerUp = A3(
	...
	function (e) {
		return _robx$elm_pointer_draw$Main$DrawEnd;
	});
var _robx$elm_pointer_draw$Main$DrawTo = function (a) {
	return {ctor: 'DrawTo', _0: a};
};
var _robx$elm_pointer_draw$Main$onPointerMove = _mpizenberg$elm_pointer_events$Pointer$onMove(
	function (e) {
		return _robx$elm_pointer_draw$Main$DrawTo(e.pointer.offsetPos);
	});
var _robx$elm_pointer_draw$Main$DrawStart = function (a) {
	return {ctor: 'DrawStart', _0: a};
};
var _robx$elm_pointer_draw$Main$onPointerDown = A3(
	_mpizenberg$elm_pointer_events$Pointer$onWithOptions,
	'pointerdown',
	{stopPropagation: false, preventDefault: true, capturePointer: true, releasePointer: false},
	function (e) {
		return _robx$elm_pointer_draw$Main$DrawStart(e.pointer.offsetPos);
	});
var _robx$elm_pointer_draw$Main$view = function (model) {
	var drawing = function () {
		var _p7 = model.draw;
		if (_p7.ctor === 'Just') {
			return {
				ctor: '::',
				_0: _robx$elm_pointer_draw$Main$toForm(_p7._0),
				_1: model.drawing
			};
		} else {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _robx$elm_pointer_draw$Main$onPointerDown,
			_1: {
				ctor: '::',
				_0: _robx$elm_pointer_draw$Main$onPointerMove,
				_1: {
					ctor: '::',
					_0: _robx$elm_pointer_draw$Main$onPointerUp,
					_1: {
						ctor: '::',
...
var _robx$elm_pointer_draw$Main$main = _elm_lang$html$Html$program(
	{init: _robx$elm_pointer_draw$Main$init, update: _robx$elm_pointer_draw$Main$update, view: _robx$elm_pointer_draw$Main$view, subscriptions: _robx$elm_pointer_draw$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _robx$elm_pointer_draw$Main$main !== 'undefined') {
    _robx$elm_pointer_draw$Main$main(Elm['Main'], 'Main', undefined);
}
