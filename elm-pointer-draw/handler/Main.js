...
var _mpizenberg$elm_mouse_events$Mouse$stopOptions = {stopPropagation: true, preventDefault: true};
...
var _robx$elm_pointer_draw$Main$onPointerUp = _mpizenberg$elm_pointer_events$Pointer$onUp(
	function (e) {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'onPointerDown', 'function(event) { event.target.setPointerCapture(event.pointerId); }'),
							_1: {ctor: '[]'}
						}
					}
				}
